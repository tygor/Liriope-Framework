...
<head>
  ...
  <title><?= self::get( 'page.title' ); ?></title>
  ...
  <?php foreach( self::getStylesheets() as $css ): ?>
  <link rel="<?= $css['rel']; ?>" href="css/<?= $css['file']; ?>">
  <?php endforeach; ?>
...
<body class="<?= self::get( 'body.class' ); ?> <?= "$ua[shortname] $ua[shortname]$ua[shortver] $ua[platform]"; ?>">
