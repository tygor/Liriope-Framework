...
$sample = new StringExtensions("The quick brown fox jumps over the lazy dog.");
...
<h2>new StringExtensions( $the_string )</h2>
...
<pre>$string = new StringExtensions( '<?= $sample->peek() ?>' );</pre>
...
<pre>
$string = new StringExtensions( '<?= $sample ?>' );
