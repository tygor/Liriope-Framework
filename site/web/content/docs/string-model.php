...
$sample = new LiriopeString("The quick brown fox jumps over the lazy dog.");
...
<h2>new LiriopeString( $the_string )</h2>
...
<pre>$string = new LiriopeString( '<?= $sample->peek() ?>' );</pre>
...
<pre>
$string = new LiriopeString( '<?= $sample ?>' );
